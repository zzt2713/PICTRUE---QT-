...
static constexpr auto qt_meta_stringdata_ZN14OpenTreeThreadE = QtMocHelpers::stringData(
    "OpenTreeThread",
    "SigFinishProgress",
    "",
    "SigUpdateProgress"
...
Q_CONSTINIT static const uint qt_meta_data_ZN14OpenTreeThreadE[] = {
...
Q_CONSTINIT const QMetaObject OpenTreeThread::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN14OpenTreeThreadE.offsetsAndSizes,
    qt_meta_data_ZN14OpenTreeThreadE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN14OpenTreeThreadE_t,
        // Q_OBJECT / Q_GADGET
...
void OpenTreeThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (OpenTreeThread::*)(int );
            if (_q_method_type _q_method = &OpenTreeThread::SigFinishProgress; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _q_method_type = void (OpenTreeThread::*)(int );
            if (_q_method_type _q_method = &OpenTreeThread::SigUpdateProgress; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
void *OpenTreeThread::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN14OpenTreeThreadE.stringdata0))
