...
static constexpr auto qt_meta_stringdata_ZN7ProTreeE = QtMocHelpers::stringData(
    "ProTree",
    "AddProToTree",
    "",
    "name",
...
Q_CONSTINIT static const uint qt_meta_data_ZN7ProTreeE[] = {
...
Q_CONSTINIT const QMetaObject ProTree::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN7ProTreeE.offsetsAndSizes,
    qt_meta_data_ZN7ProTreeE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN7ProTreeE_t,
        // Q_OBJECT / Q_GADGET
...
void *ProTree::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN7ProTreeE.stringdata0))
